...
⛔ **industry / business_size / online_assets / bottleneck / reason 这五个字段
会一字不改地印在发给他本人看的那页纸上。** 所以：

- 一律用第二人称「你」，不许出现「他」「该商家」「这个人」
- 不要写你的推理过程。「无员工/分店痕迹」「笔记标题带🇨🇦Markham」这类是
  给我们自己看的判断依据，印在客户那页上只会显得像监视报告
- industry ≤ 15 字，business_size 只填「个人」「单店」「多店」「公司」四个词之一

只输出一个 JSON 对象，不要代码块、不要解释文字：
{
  "industry": "<≤15字，如「美甲工作室 · Markham」。看不出就留空>",
  "business_size": "<只填：个人 / 单店 / 多店 / 公司。看不出就留空>",
  "online_assets": "<用「你」说他现在有什么线上资产。看不出就留空>",
  "bottleneck": "<用「你」说他没意识到的那个真正瓶颈。找不出就留空>",
  "product_line": "<从上面四个里选一个>",
  "reason": "<用「你」说为什么是这条产品线，一句话>",
  "dm_draft": "<私信第一句草稿>"
}`;
