...
/**
 * ⛔ 搜「XX 餐厅」抓到的是**食客的探店笔记**，不是餐厅老板。
 *
 * 2026-08-13 实测「温哥华 华人 餐厅」四条全是 25–35 分：@umi小章鱼、
 * @vansky温哥华天空、@Fituna、@怡然自得 —— L1 正确归进了「探店号/测评号」
 * 那一档，判断没问题，是词选错了。
 *
 * 背后是真实的品类差异：**美甲美睫师靠小红书获客（作品即广告），
 * 餐饮不靠** —— 餐厅老板在 Google / Yelp 上经营，小红书上是顾客在替他发内容。
 *
 * 所以「会员积分」这条产品线（餐饮零售回头客生意）在小红书上不好找客户。
 * 要么换平台（Google Business），要么找到餐饮业主自己会发的内容形态
 * （招聘？新店开业？），后者尚未验证 —— 别凭猜想往词表里加。
 */
export const UNVERIFIED_KEYWORDS = ["温哥华 华人 餐厅", "多伦多 甜品店", "西雅图 华人 超市"];
